...
module.exports = {
  apps: [
    {
      name: 'mhc-dev',
      cwd: '/Users/tracysmith/Development/mhc/code/mhc-cp',
      script: 'pnpm',
      args: '--parallel -r dev',
      ...
      autorestart: true,
      // Keep logs readable
      out_file: '/Users/tracysmith/.pm2/logs/mhc-dev-out.log',
      error_file: '/Users/tracysmith/.pm2/logs/mhc-dev-error.log',
      time: true,
    },
    {
      name: 'personal-dam-dev',
      cwd: '/Users/tracysmith/Development/refineo/code/personal-dam',
      script: 'pnpm',
      args: 'dev',
      env: { NODE_ENV: 'development' },
      restart_delay: 8000,
      max_restarts: 50,
      autorestart: true,
      out_file: '/Users/tracysmith/.pm2/logs/personal-dam-dev-out.log',
      error_file: '/Users/tracysmith/.pm2/logs/personal-dam-dev-error.log',
      time: true,
    },
  ],
};
